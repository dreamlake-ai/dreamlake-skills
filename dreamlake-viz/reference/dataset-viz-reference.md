...
synced across episodes under a `SyncScrollProvider`.

| view           | binds                                                                                                                                                                          | slot → payload                                                           | keys of note                                                                                                                                                                                                                                                                                                                                                                                                               |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
`registerComponent({ name, component, reads, slotNames? })` — `reads`
...
`{ fields, info?, read, timeline, cursor, config }`.
