...
Source: [owning guide](https://docs.dreamlake.ai/envs) and [Profiles and workspaces](https://docs.dreamlake.ai/workspaces). The companion workspace revision is recorded in `sources.json`. This browsing section is reconciled explicitly with the owning docs; it is not generated by the Notes/CLI synchronizer.
